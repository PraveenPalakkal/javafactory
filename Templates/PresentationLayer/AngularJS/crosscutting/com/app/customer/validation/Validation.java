...
public class Validation {
	public void  isCustomerValidate(Customer customer) throws HexValidationException{
		String message="";
	...
	Validator validator=null;
		...
		numberValidator.numberValidation(customer.getCustomerid().toString()==null?"":customer.getCustomerid().toString());
		validationRule.setFieldValue(customer.getName()==null?"":customer.getName());
		...
		validationRule.setFieldValue(customer.getAddress()==null?"":customer.getAddress());
		validationRule.setNotEmptey(true);
		validationRule.setIsNotNull(true);
		message=" Customer Address";
		validator.isValidDate(validationRule);
		message="";
		validationRule.setFieldValue(customer.getOrders()==null?"":customer.getOrders());
		validationRule.setNotEmptey(true);
		validationRule.setIsNotNull(true);
		message=" Customer Order";
		validator.isValidDate(validationRule);
		
		validationRule.setFieldValue(customer.getAction()==null?"":customer.getAction());
		message="";
		validationRule.setNotEmptey(true);
		validationRule.setIsNotNull(true);
