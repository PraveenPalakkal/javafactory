	...
	customerApp.service('addCustomer', function($http,serverIp){
		this.call = function(customer, successCallBack, failureCallBack){
			$http({
				...
				data: JSON.stringify({
					serviceType: "REST",
					service : serverIp + "${serviceProjectName}/${Rest_URL}/ws/save",
					serviceMethod: "POST",
					paramType:"",
	...
	customerApp.service('searchCustomers', function($http,serverIp){
		this.call = function(searchData, searchField, successCallBack, failureCallBack){
			$http({
				...
				data: JSON.stringify({
					serviceType: "REST",
					service :  serverIp + "${serviceProjectName}/${Rest_URL}/ws/search",
					serviceMethod: "GET",
					paramType:"",
	...
	customerApp.service('deleteCustomers', function($http,serverIp){
		this.call = function(customers, successCallBack, failureCallBack){
			$http({
				...
				data: JSON.stringify({
					serviceType: "REST",
					service : serverIp + "${serviceProjectName}/${Rest_URL}/ws/delete",
					serviceMethod: "POST",
					paramType:"",
	...
	customerApp.service('updateCustomer', function($http, serverIp){
		this.call = function(customer, successCallBack, failureCallBack){
			$http({
				...
				data: JSON.stringify({
					serviceType: "REST",
					service : serverIp + "${serviceProjectName}/${Rest_URL}/ws/update",
					serviceMethod: "POST",
					paramType:"",
					param: JSON.stringify(customer),
				})
	...
	customerApp.service('listCustomers', function($http, serverIp){
		this.call = function(successCallBack, failureCallBack){
			$http({
				...
				data: JSON.stringify({
					serviceType: "REST",
					service : serverIp + "${serviceProjectName}/${Rest_URL}/ws/list",
					serviceMethod: "GET",
					paramType:"",
