...
public class CustomerAdd {
	...
	public boolean insert(CustomerVO customer) throws JsonGenerationException, JsonMappingException, IOException
	{
	...
	public boolean update(CustomerVO customer) throws JsonGenerationException, JsonMappingException, IOException
	{
