...
public class CustomerAdd {
	...
	public boolean insert(Customer customer) throws JsonGenerationException, JsonMappingException, IOException
	{
		...
		String output = delegate.doBusiness("POJO",
				"com.app.customer.service.CustomerImpl", "insert",
	...
	public boolean update(Customer customer) throws JsonGenerationException, JsonMappingException, IOException
	{
		...
		${Validation_Call}
		String output = delegate.doBusiness("POJO",
				"com.app.customer.service.CustomerImpl", "update",
				"com.app.customer.vo.Customer",jsonInString);
		log.debug("output : " + output);
		}${Validation_CatchAdd}
		catch (Exception e) {
