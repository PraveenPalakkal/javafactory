		...
		<div id="page-content-wrapper">
			<div class="container-fluid">
				...
				<div>
				 ...
				 <form id="customerForm" action="<%=request.getContextPath()%>/auth/clear" method="post">
					...
					<disp:table id="customer" name="customerList" class="table table-striped table-condensed table-bordered table-hover"
						...
						<disp:column title="Customer Id">
							<a href="<%=request.getContextPath()%>/auth/customerSelect?id=<s:property value="#attr.customer.customerid"/>">
					...
					<div style="margin-left:78%;margin-top: 3px;">	
						...
						<s:submit value="%{getText('CUSTOMER_BUTTON_DELETE')}" cssClass="button"
						 ...
						 <s:submit value="email" action="email"
							 	 cssClass="button" disabled="%{email}" ></s:submit>	
					 </div>				
				 </form> 
				</div>
			</div>
